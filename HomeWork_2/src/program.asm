...
section .data
        ...
        okMessage db 'Everything is OK.', 10, 13, 0
 ...
 section .text
        _main:
                ...
                mov eax, [rel N]
                cmp eax, [rel one]                  ; проверяем, был ли размер меньше единицы
                jl _WrongInput
                ...
                imul rdi, 4
                call _malloc ; ищем участок памяти на N чисел размером 8 байт
                mov [rel taskArr], rax ; записываем в arr адрес первой ячейки найденного участка
